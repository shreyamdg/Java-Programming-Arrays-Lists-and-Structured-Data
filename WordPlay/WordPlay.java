...
/**
 * The code here checks for vowel, exchanges the Vowel with a '*'. It also replaces ‘*’ if 'ch' is in an odd number location in the string and '+' if it is in the even number of the string.
 * 
