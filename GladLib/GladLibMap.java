 /*
 * This is a implementation of the same program in directory, but using HashMaps. 
 * It creates a story from a template and replaces the tags from the files included.
...
public class GladLibMap {
    ...
    public static void main(String[] args) {
    	GladLibMap glm = new GladLibMap("datalong");
    	glm.makeStory();
	}
